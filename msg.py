...
decide_before_price = "Someone can swipe you in for "
decide_after_price = " dollars. Do you accept? Please respond with yes or no."
...
check = "Has someone come to swipe you in? If not, respond 'no' and we can try to find someone else. If someone has come, please respond 'yes'" 
complain = "Sorry about that. We'll try to find someone else."
fail = "Sorry. We couldn't find anyone to swipe you in. :( "
retry = "Oops. The person we matched you with just left. We'll try to find someone else."
